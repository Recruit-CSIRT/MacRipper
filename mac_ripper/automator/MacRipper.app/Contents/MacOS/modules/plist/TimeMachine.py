...
class Finder:
    ...
    def __init__(self, evidence_root, output_path):
        ...
        self.users_plist = {}
        self.plist_path = 'Library/Preferences/com.apple.TimeMachine.plist'
        self.text = "----------------------------------------------------------\n"
        self.text += "[*] Volume positions from finder plist.\n"
        self.text += "[*] This attribute show the TimeMachine settings.\n"
        self.search()

    def parse_volume_positions(self, file_path):
